...
export const tamboComponents = [
  {
    name: 'DataTable',
    description: 'Displays structured data such as bugs, tasks, issues, or team members. Use for any list with columns.',
    component: DataTable,
  ...
  {
    name: 'MetricCard',
    description: 'Displays a single KPI with a trend and optional sparkline. Use for summary metrics.',
  ...
  {
    name: 'TimelineView',
    description: 'Chronological timeline of events. Use for activity feeds, commits, meetings, or updates.',
  ...
  {
    name: 'ActionForm',
    description: 'Simple action form for scheduling meetings or creating items.',
